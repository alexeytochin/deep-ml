...
module Numeric.InfBackprop.TutorialExamples4 where
...
import Numeric.InfBackprop.BackpropDiff4 (derivative)
...
import Numeric.InfBackprop.Tangent (CT, BoxedVec)
import Numeric.InfBackprop.BackpropDiff4 (BackpropDiff)
...
-- f' :: forall a. (SymbolicFunc a, DifferentiableArgScalar a, Distributive a, a ~ CT a) => a -> a
-- f' = gradient @a f -- (f :: BackpropDiff a a -> BackpropDiff a a)
